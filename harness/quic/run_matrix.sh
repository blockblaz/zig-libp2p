...
elif [[ -x "./harness/quic/impls/go-libp2p/interop-quic-node-go" ]]; then
    GO_BIN="./harness/quic/impls/go-libp2p/interop-quic-node-go"
fi

# rust-libp2p
if command -v interop-quic-node-rust >/dev/null 2>&1; then
    RUST_BIN="$(command -v interop-quic-node-rust)"
elif [[ -x "./harness/quic/impls/rust-libp2p/target/release/interop-quic-node-rust" ]]; then
    RUST_BIN="./harness/quic/impls/rust-libp2p/target/release/interop-quic-node-rust"
fi
