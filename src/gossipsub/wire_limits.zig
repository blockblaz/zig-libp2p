...
//! Aligns loosely with req/resp `max_rpc_message_size` (4 MiB) for large payloads.

/// Maximum length-delimited field taken from an outer `RPC` message (publish blob, control blob, …).
pub const max_rpc_length_delimited_bytes: usize = 4 * 1024 * 1024;
...
pub const max_gossip_message_wire_bytes: usize = 4 * 1024 * 1024;
