...
pub const transport = struct {
    ...
    pub const ws_codec = @import("transport/ws_codec.zig");
    pub const ws_handshake = @import("transport/ws_handshake.zig");
...
test {
    ...
    _ = @import("transport/ws_codec.zig");
    _ = @import("transport/ws_handshake.zig");
    _ = @import("transport/ws.zig");
